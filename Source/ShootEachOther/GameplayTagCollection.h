...
namespace GameplayTagsCollection {
	...
	SHOOTEACHOTHER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Input_Slot01);
	SHOOTEACHOTHER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Input_Slot02);
	SHOOTEACHOTHER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Input_Slot03);
	SHOOTEACHOTHER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Input_Slot04);
