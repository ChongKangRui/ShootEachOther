...
void AGM_MainMenu::BeginPlay()
{
    ...
    // Get the OnlineSubsystem we want to work with
     ...
     //SessionInterface->OnFindSessionsCompleteDelegates.AddUObject(this, &AGM_MainMenu::OnFindSessionComplete);
     //SessionInterface->OnCreateSessionCompleteDelegates.AddUObject(this, &AGM_MainMenu::OnCreateSessionComplete);
     //SessionInterface->OnJoinSessionCompleteDelegates.AddUObject(this, &AGM_MainMenu::OnJoinSessionComplete);
}
